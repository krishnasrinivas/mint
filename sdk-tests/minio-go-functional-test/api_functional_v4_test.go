...
// flag to indicate whether SSL is enabled.
var enableSSL bool
...
// 	n, err := c.PutObject(bucketName, objectName, bufReader, objectContentType)
// 	if err != nil {
...
// AZURENA - this function is crashing. FIXME.
...
// 	size, err := file.Write(bytes.Repeat([]byte("0"), minPartSize*4))
// 	if err != nil {
// 		t.Fatal("Error:", err)
// 	}
